...
shell.execute("rm", "AdvancedGUI.lua")
shell.execute("rm", "rpc_gui_host.lua")
...
shell.execute("wget", "https://raw.githubusercontent.com/LittleLigr/cc-rednet-wrapper/refs/heads/main/AdvancedGUI.lua")
